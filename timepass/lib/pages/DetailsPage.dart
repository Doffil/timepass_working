...
//    print(dropDownDefaultValue);
    for (int i = 0; i < productData["product_images"].length; i++) {
      imagesList.add(
          NetworkImage(productData["product_images"][i]["product_image_url"]));
    }
    // added data to items list
//    print('length is'+productData["product_variable"].length.toString());
//    print(productData["product_variable"][0]["variable_selling_price"]);
...
//    print('it is: '+ detail_variable[0].sprice.toString());
  }
